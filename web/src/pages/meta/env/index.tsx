...
import { queryEnv, updateEnv, addEnv, removeEnv } from './service';
...
const formInitValue = {"id":0,"env_name":"","description":""}
  ...
  return (
    <PageContainer>
      <ProTable<TableListItem>
        ...
        request={(params, sorter, filter) => queryEnv({ ...params, sorter, filter })}
        columns={columns}
      />
