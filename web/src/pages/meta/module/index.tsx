...
import { queryModule, updateModule, addModule, removeModule } from './service';
...
const formInitValue = {"id":0,"module_name":"","description":""}
...
const TableList: React.FC<{}> = () => {
  ...
  const columns: ProColumns<TableListItem>[] = [

    {
      ...
      initialValue: formValues.module_name,
      sorter: false,
      search: false,
      formItemProps: {
        rules: [
    ...
    },
    {
      ...
      render: (_, record) => (
        <>
          ...
          <Popconfirm
            title={`确认要删除数据【${record.module_name}】,删除后不可恢复，是否继续？`}
            placement={"left"}
            onConfirm={async ()=>{
